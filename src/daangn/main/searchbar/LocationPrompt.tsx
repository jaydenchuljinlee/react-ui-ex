...
const MainLocationPrompt = ({ categories }: MainLocationPromptProp) => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            setCurrentWord(categories[index]);
    ...
    return (
        <div
            className="mb_16_large mt_32_small mt_12_base mb_12_small display_flex_base justifyContent_center_base"
        >
            <h2
                className="main_h2_font"
            >
                <div className="display_inlineFlex_small mr_1.5_small width_8_small">
                ...
                역삼동
                에서
                {/* <br className="display_none_small"></br> */}
                <div
                    className="display_inlineFlex_small"
